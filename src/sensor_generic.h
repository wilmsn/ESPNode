...
public:
    ...
    /// @param json Ein übergebener String der komplett mit json Syntax gefüllt wird
    ...
    /// @brief Gibt json formatierte Sensorinformationen aus. Diese Funktion muss innerhalb des abgeleiteten Objektes befüllt werden.
    ...
    /// @brief Informationen zum Sensor als json abgespeichert;
    String     obj_sensorinfo;
